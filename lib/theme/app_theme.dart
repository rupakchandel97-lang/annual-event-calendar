...
class AppTheme {
  ...
  static final List<AppThemePalette> themes = [
    ...
    const AppThemePalette(
      ...
      name: 'Olive & Rust',
      description: 'Moody teal, rust, amber, and slate inspired by the reference palette.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      name: 'Teal Rust',
      description: 'Painterly teal and copper tones with strong warmth and contrast.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      description: 'Neon aqua, electric pink, and deep berry from the tropical reference.',
      brightness: Brightness.dark,
    ...
    const AppThemePalette(
      ...
      name: 'Bold',
      description: 'Confident orange, mushroom red, and cream with a poster-like feel.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      name: 'Soft Colors',
      description: 'Airy pastel mint, blush, and butter for a calm family workspace.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      description: 'Turquoise, peacock blue, and sandy neutrals with crisp contrast.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      description: 'Jewel-toned teal, copper, and moss pulled from butterfly-meadow references.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      name: 'Vivid Chroma',
      description: 'High-energy botanical brights with saturated coral, teal, and lime.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      name: 'HyperDesign',
      description: 'A futuristic cyan-magenta contrast palette with deep-night framing.',
      brightness: Brightness.dark,
    ...
    const AppThemePalette(
      ...
      name: 'Random Bright',
      description: 'Playful punchy brights for a cheerful, high-visibility planner.',
      brightness: Brightness.light,
    ...
    const AppThemePalette(
      ...
      name: 'Fruits',
      description: 'Fresh citrus, berry, and leafy tones inspired by fruit-forward boards.',
      brightness: Brightness.light,
